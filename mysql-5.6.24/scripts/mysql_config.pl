...
my $socket  = '/data/mysqlsecond/mysql.sock-DENABLED_LOCAL_INFILE=1';
my $version = '5.6.24';
...
my $ldata   = '/data/mysqlsecond';
my $execdir = '/usr/local/mysqlsecond/bin';
my $bindir  = '/usr/local/mysqlsecond/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/usr/local/mysqlsecond/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/usr/local/mysqlsecond/include', "include/mysql", "include");
